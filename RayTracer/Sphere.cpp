...
double Sphere::findIntersection(Ray ray) {
	...
	double b = (2.0 * (ray_origin_x - sphere_center_x) * ray_direction_x) + (2.0 * (ray_origin_y - sphere_center_y) * ray_direction_y) + (2.0 * (ray_origin_z - sphere_center_z) * ray_direction_z);
